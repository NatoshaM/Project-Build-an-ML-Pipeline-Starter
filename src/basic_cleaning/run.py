...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help ="The input artifact file path from wandb to be cleaned", ## INSERT DESCRIPTION HERE,
        required = True
    )
    ...
    parser.add_argument(
        "--output_artifact", 
        type =str, ## INSERT TYPE HERE: str, float or int,
        help ="The name for the output artifact after cleaning", ## INSERT DESCRIPTION HERE,
        required = True
    )
    ...
    parser.add_argument(
        ...
        help ="The minimum price to consider for filtering out data", ## INSERT DESCRIPTION HERE,
        required = True
    )
    ...
    parser.add_argument(
        "--max_price",
        type =float, ## INSERT TYPE HERE: str, float or int,
        help ="The maximum price to consider for filtering out data", ## INSERT DESCRIPTION HERE,
        required = True
    )
